...
%>
  ...
  try
  {
		...
		String query1="select * from disposaldetails where prisonid='"+prisonerid+"'";
  ...
  <div id="main1">
    <div id="example" class="post">
      <div id="div" class="boxed">
            <h2 class="title">View DISPOSAL INFORMATION</h2>
			  <div class="content">
    ...
    <tr>
      ...
      <td><h3>Name</h3></td>
      <td><h3>Prisoner Status</h3></td>
	  <td><h3>Entry Date</h3></td>
	 <td><h3>Exit Date</h3></td>
    </tr>
    <%
	while(rs.next())
	{
	...
	out.println("<td width=100>"+rs.getString("prisonerstatus") +"</td>\n");
	out.println("<td width=100>"+rs.getString("entrydate") +"</td>\n");
	out.println("<td width=100>"+rs.getString("exitdate") +"</td>\n");
	}
