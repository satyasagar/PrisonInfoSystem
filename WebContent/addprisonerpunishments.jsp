...
String query2="select prisonid from prisonersreg where jailid='"+jailid+"' order by prisonid";
  ...
  <div id="main">
    <div id="example" class="post">
      <div id="div" class="boxed">
            <h2 class="title">View Prisoner Punishments&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="jailor.jsp">Back</a> </h2>
			  <div class="content">
				
				 <form name="form2" action="viewprisonerpunishments.jsp" method="post" >
