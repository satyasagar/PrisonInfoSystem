  ...
  <div id="main">
    <div id="example" class="post">
      <div id="div" class="boxed">
            <h2 class="title">Add DISPOSAL Details&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="jailor.jsp">Back</a> </h2>
			  <div class="content">
				
				 <form name="form2" action="adddisposaldetails2.jsp" method="post" >
				...
				<tr>
                <th> <div align="center">Prisoner Status </div></th>
                <td><select name="ps">
				...
				<tr>
                 <th width="155"><div align="center">Entry Date </div></th>
