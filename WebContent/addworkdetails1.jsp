  ...
  <div id="main">
    <div id="example" class="post">
      <div id="div" class="boxed">
            <h2 class="title">Add Work Details&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="jailor.jsp">Back</a> </h2>
			  <div class="content">
				
				 <form name="form2" action="addworkdetails2.jsp" method="post" >
				...
				<tr>
                <th> <div align="center">Work Type </div></th>
                <td><select name="worktype">
				<option>select</option>
				<option value="Gardening">Gardening</option>
				<option value="Stone Crushing Time">Stone Crushing Time</option>
				<option value="Carpentry">Carpentry</option>
				<option value="Cooking">Cooking</option>
				<option value="Tailering">Tailering</option>
				</td></tr>

				<tr>
                <th width="155"><div align="center">Work Description</div></th>
                <td width="275"><input type="text" name="workdesc"   /></td></tr>

				<tr>
                 <th width="155"><div align="center">Start Date </div></th>
				...
				<tr>
                <th width="155"><div align="center"></div></th>
                <td width="275"><input type="hidden" name="status"   value="<%=status%>" /></td></tr>
