  ...
  <div id="main">
    <div id="example" class="post">
      <div id="div" class="boxed">
            <h2 class="title">Add Jailors &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="admin3.jsp">Back</a></h2>
			  <div class="content">
				
				 <form name="form2" action="addjailors1234.jsp" method="post" >
            <table border="0" align="center" cellpadding="0" cellspacing="2">
                <tr>
                <th width="155"><div align="center">Jailor ID</div></th>
                <td width="275"><input type="text" name="jailorid" readonly  value="<%=std%>" /></td></tr>
              
              <tr>
                <th><div align="center">Jailor Name</div></th>
                <td><input type="text" name="jname" value="" /></td></tr>
				
				<tr>
                 <th width="155"><div align="center">Alloted Jail Name</div></th>
                 <td width="275"><select name="ajname" />
				 <%
				 while(rs1.next())
				 {
				 %>
				...
				<tr>
                 ...
                 <td width="275"><input type="text" name="bdate" value="" /><a href="javascript:show_calendar('document.form2.bdate', document.form2.bdate.value);"> <img src="images/cal.gif" alt="a" width="18" height="18" border="0"/></a></td></tr>
				
				 <tr>
			 <th width="155"><div align="center">Address </div></th>
			 <td width="275">
			<textarea name="address" class="text">
			</textarea></td>
			 </tr>
