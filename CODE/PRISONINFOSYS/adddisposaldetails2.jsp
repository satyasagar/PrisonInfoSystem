...
String query="insert into disposaldetails(prisonid,name,prisonerstatus,entrydate,exitdate)  values('"+prisonerid+"','"+name+"','"+ps+"','"+bdate1+"','"+bdate2+"')";
...
%>
<jsp:forward  page="adddisposaldetails12345.jsp">
