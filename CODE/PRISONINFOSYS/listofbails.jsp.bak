...
%>
  ...
  try
  {
		...
		String query1="select * from baildetails where prisonid='"+prisonerid+"'";
...
<div id="content">
  <div id="main1">
	...
	out.println("<td width=100>"+rs.getString("bailid") +"</td>\n");
	out.println("<td width=100>"+rs.getString("exitdate") +"</td>\n");
	out.println("<td width=100>"+rs.getString("reportdate") +"</td>\n");
