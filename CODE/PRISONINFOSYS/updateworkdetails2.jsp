...
System.out.println(".....................From addworkdetails2.jsp...........");
...
String query="update workdetails set status='"+status+"' where prisonid='"+prisonerid+"'";
...
%>
<jsp:forward  page="updateworkdetails12345.jsp">
