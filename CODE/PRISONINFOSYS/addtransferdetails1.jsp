...
String query3="select jailid from newjail where jailid != '"+jailid+"'";
  ...
  <div id="main">
    <div id="example" class="post">
      <div id="div" class="boxed">
            <h2 class="title">Add Transfer Details&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="jailor.jsp">Back</a> </h2>
			  <div class="content">
				
				 <form name="form2" action="addtransferdetails2.jsp" method="POST" >
				...
				<tr>
                <th> <div align="center">Transfer Location(JAIL ID) </div></th>
                <td><select name="jail2">
				<%
				while(rs3.next())
				{
					%>
				<option><%=rs3.getString(1)%>
				...
				<tr>
                <th width="155"><div align="center">Reason for Transferring</div></th>
                <td width="275"><input type="text" name="rft"  /></td></tr>
